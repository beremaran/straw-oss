...
| --- | --- | --- | --- | --- | --- |
| [MU-001](tasks/MU-001-frontend-workspace-build.md) | 1 | not-started | Frontend workspace and build integration | none | frontend workspace, dev server, build, test, `web/management` |
