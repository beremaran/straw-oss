...
| REST streaming variant `/api/v1/requests:stream`. | implemented by later task | CLI stream client support is implemented by `docs/tasks/p1/28-sdk-cli-rest-streaming-client.md`. |
