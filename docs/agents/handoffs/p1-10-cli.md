...
| REST streaming variant `/api/v1/requests:stream`. | out of scope | Owned by `docs/tasks/p1/06-rest-streaming-endpoint.md`; board notes it is blocked by `docs/planning/32-open-decisions.md`. |
