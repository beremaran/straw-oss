...
This historical board maps the P2 scope from `docs/planning/02-phase-boundaries.md` and
...
| 32b | done | [Python Egress SDK assignment runtime](./p2/32b-python-egress-sdk-assignment-runtime.md) |
