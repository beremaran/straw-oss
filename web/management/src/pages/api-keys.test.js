...
describe('API Keys Management Page', () => {
  ...
  beforeEach(() => {
    ...
    state.apiKeysData = {
      keys: [
        { id: 'key-1', name: 'Production Key', is_active: true, scopes: ['region:us', 'type:residential'], rate_limit_override: 100 },
        { id: 'key-2', name: 'Test Key', is_active: false, scopes: ['region:eu'], rate_limit_override: 0 }
      ]
    };
