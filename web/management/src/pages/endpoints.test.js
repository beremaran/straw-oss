...
describe('Endpoints Monitoring Page', () => {
  ...
  beforeEach(() => {
    ...
    state.endpointsData = [
      { id: 'ep-active', state: 'healthy', active_tasks: 5, tags: ['residential'], version: 'v1.0.0', last_seen: '2026-06-30T08:34:40.000Z' }, // 12s ago (Active)
      { id: 'ep-stale', state: 'suspect', active_tasks: 0, tags: ['mobile'], version: 'v1.0.0', last_seen: '2026-06-30T08:34:10.000Z' }, // 42s ago (Stale)
      { id: 'ep-draining', state: 'draining', active_tasks: 2, tags: ['datacenter'], version: 'v1.0.0', last_seen: '2026-06-30T08:34:45.000Z' }
    ];
