...
describe('Fingerprints Presets Page', () => {
  ...
  beforeEach(() => {
    ...
    state.fingerprintsData = [
      { id: 'chrome-desktop', name: 'Chrome Desktop Preset', config: { user_agent: 'Mozilla/5.0 Chrome/120.0.0.0 Safari/537.36' }, updated_at: '2026-06-30T00:00:00Z' },
      { id: 'firefox-mobile', name: 'Firefox Mobile Preset', config: { user_agent: 'Mozilla/5.0 Android Firefox/115.0' }, updated_at: '2026-06-30T00:00:00Z' }
    ];
    state.rulesData = [
