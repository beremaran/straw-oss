...
func TestAuthMiddleware(t *testing.T) {
	...
	t.Run("Valid Bearer Token", func(t *testing.T) {
		...
		validAPIKey := &domain.APIKey{ID: testAPIKeyID, TokenHash: tokenHash, IsActive: true}
		validToken := &domain.APIKeyToken{ID: "token", APIKeyID: testAPIKeyID, TokenHash: tokenHash, Status: domain.TokenStatusActive}
	...
	t.Run("Inactive API Key", func(t *testing.T) {
		...
		inactiveAPIKey := &domain.APIKey{ID: testAPIKeyID, TokenHash: tokenHash, IsActive: false}
		inactiveToken := &domain.APIKeyToken{ID: "token", APIKeyID: testAPIKeyID, TokenHash: tokenHash, Status: domain.TokenStatusActive}
