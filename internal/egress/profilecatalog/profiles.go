// Code generated from tls-client v1.15.1 profile data; DO NOT EDIT.
...
// Priority is the wire-level HTTP/2 priority frame metadata used by the
// pinned tls-client catalogue. x/net/http2 exposes PriorityParam but not the
// transport-specific wrapper that fhttp used.
...
func NewClientProfile(clientHelloId tls.ClientHelloID, settings map[http2.SettingID]uint32, settingsOrder []http2.SettingID, pseudoHeaderOrder []string, connectionFlow uint32, priorities []Priority, headerPriority *http2.PriorityParam, streamID uint32, allowHTTP bool, http3Settings map[uint64]uint64, http3SettingsOrder []uint64, http3PriorityParam uint32, http3PseudoHeaderOrder []string, http3SendGreaseFrames bool) ClientProfile {
