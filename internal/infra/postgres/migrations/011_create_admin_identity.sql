...
WITH built_in_roles(name, description) AS (
    VALUES
        ('Owner', 'All management permissions'),
...
INSERT INTO admin_roles (name, description, is_builtin)
...
JOIN admin_roles r ON r.name = rp.role_name
