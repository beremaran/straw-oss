...
COMMENT ON COLUMN api_keys.scopes IS 'Allowed tag patterns for this key, e.g. ["target:*", "type:search"]';
COMMENT ON COLUMN api_keys.rate_limit_override IS 'Optional per-key rate limit override';
-- +goose StatementEnd
