...
COMMENT
ON TABLE cost_multipliers IS 'Cost multipliers for different endpoint types';
COMMENT
ON COLUMN cost_multipliers.endpoint_tag IS 'Endpoint tag this multiplier applies to, e.g. "type:residential"';
COMMENT
ON COLUMN cost_multipliers.multiplier IS 'Cost multiplier, e.g. 10.00 means 10x base cost';
-- +goose StatementEnd
